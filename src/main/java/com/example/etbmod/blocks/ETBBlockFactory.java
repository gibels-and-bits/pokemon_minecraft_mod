...
public class ETBBlockFactory {
    ...
    static {
        // Only register ETBs that have both block textures AND card data
        ...
        // Sets with block textures but no card data - commented out until cards are added
        // registerETB("151", "151", "sv3pt5");
        // registerETB("celebrations", "Celebrations", "cel25");
        
        // Sets with no textures at all - removed
